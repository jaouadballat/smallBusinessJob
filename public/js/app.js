...
/*!
 * SlickNav Responsive Mobile templats v1.0.10
 * (c) 2016 Josh Cope
 * licensed under MIT
 */
...
{
	// CommonJS
	typeof(require) != 'undefined' ? SyntaxHighlighter = require('resources/Doc/syntax-highlighter/scripts/shCore').SyntaxHighlighter : null;
