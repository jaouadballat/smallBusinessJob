...
use Illuminate\Support\Facades\Route;
    ...
    Route::get('/job/{job}/user/{user}/messages', 'MessageController@show')->name('messages.show');
    Route::post('/job/{job}/user/{user}/messages', 'MessageController@send')->name('messages.send');
